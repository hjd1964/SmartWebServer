...
#define L_ARE_YOU_SURE "Estas seguro?"
#define L_LOGOUT "Cerrar seción"
...
// weather
#define L_TEMPERATURE "Temperaturea"
#define L_AMBIENT_TEMPERATURE "Temperatura Ambiente"
#define L_PRESSURE "Presión Barometrica"
#define L_HUMIDITY "Humedad Relativa"
#define L_DEW_POINT "Temperatura Punto de Rocio"
...
#define L_ALIGN_MESSAGE "relativo a la montura"
...
// parking
#define L_PARKING "Estacionamiento"
#define L_PARKED "Estacionado"
#define L_NOT_PARKED "No estacionado"
#define L_PARKING "Estacionamiento"
#define L_PARK_FAILED "Estacionamiento fallido"

// home
#define L_HOMING "Inicio"
#define L_AT_HOME "En inicio"
#define L_SLEWING "Giro"
...
#define L_COMMS_FAILURE "Error de comunicaciones"
#define L_STANDSTILL "Parado"
#define L_OPEN_LOAD "Carga abierta"
#define L_SHORT_GND "Corte en gnd"
...
#define L_HINT_CONTINUE_GOTO "Continuar Goto (cuando está en pausa en Inicio"
#define L_HOME_PARK_TITLE "Localización y Estacionamiento"
#define L_FIND_HOME "Buscar Inicio"
#define L_RESET_HOME "Inicio (Resetear)"
#define L_UNPARK "Desestacionar"
#define L_PARK "Estacionar"
#define L_HINT_EMERGENCY_STOP "Parada de Emergencia!"
#define L_HINT_RATE_SIDEREAL "Velocidad Sidereal"
...
#define L_HINT_DEROTATE_ON "Desrotador On"
#define L_HINT_ROTATOR_REV "Invertir Movimiento Desrotador"
#define L_HINT_ROTATOR_PAR "Mover el rotador al angulo  Paraláctico "
#define L_HINT_DEROTATE_OFF "Desrotador Apagado"
...
#define L_DEROTATOR "Desrotator"
#define L_CAMERA_EXPOSURE "Expoxición"
...
#define L_CAT_EXAMPLE5 "  Gato es un código de categoría de la siguiente manera:<br />"
...
#define L_CAT_UPLOAD_INDEX_FAIL "Falló la carga, nombre del catálogo de indexación rec."
#define L_CAT_DELETE_FAIL "Falló la carga, eliminando el nombre del catálogo rec."
#define L_CAT_WRITE_NAME_FAIL "Falló la carga, escribiendo el nombre del catálogo rec."
...
// general settings
#define L_ENC_SYNC_TO_ENC "Sincronizar OnStep -> Codificadores"
#define L_ENC_SYNC_TO_ONS "Sincronizar Codificadores-> OnStep"
#define L_ENC_ORIGIN_TO_ONS "Colocar OnStep -> Codificadores en  Origen"
#define L_ENC_AUTO_SYNC "Sincronizar automáticamente   Codificadores-> OnStep"
#define L_ENC_CONF " Configurar Codificadores"
...
#define L_PEC_EEWRITE_MESSAGE "Escribe los datos PEC en la EEPROM para que se recuerden si OnStep se reinicia. La escritura de los datos puede tardar unos segundos."
#define L_DISABLED_MESSAGE "Desabilitado"
...
#define L_PARK "Estacionar"
#define L_SET_PARK "Colocar en Estación"
...
#define L_BUZZER "Desplazarse a Alerta, Zumbador"

#define L_MERIDIAN_FLIP_AUTO "Volteo de meridiano automático en el límite"
#define L_MERIDIAN_FLIP_NOW "Ahora"
#define L_MERIDIAN_FLIP_PAUSE "Meridiano Ahora, pausa en Inicio"
...
#define L_LIMITS_RANGE_OVERHEAD "Arriba, altitud máxima 60 to 90&deg;"
...
#define L_LOCATION_MESSAGE_UTC_OFFSET "Opuesto a un valor de zona horaria, esto es para la hora estándar (no para la hora de verano)."
...
#define L_ADV_SET_SPM "Pasos por Micropasos"
...
#define L_ADV_SET_GOTO_us "Micropasos Desplazarse a"
#define L_ADV_SET_HOLD_ma "Corriente de retención en mA"
#define L_ADV_SET_TRAK_ma "Corriente de seguimiento en mA"
#define L_ADV_SET_SLEW_ma "Corriente de oscilación en mA"
#define L_ADV_SET_P "Seguimiento proporcional"
#define L_ADV_SET_I "Seguimiento Integral"
#define L_ADV_SET_D "Seguimiento de Deriva"
#define L_ADV_SET_P_GOTO "Giro Porporcional"
#define L_ADV_SET_I_GOTO "Giro Integral"
#define L_ADV_SET_D_GOTO "Giro Derivative"
...
#define L_ADV_SET_AXIS_NO_EDIT "Desabilitar la edición del eje axis."
...
#define L_WIPE_RESET "Borre todas las configuraciones y reinicie OnStep"
#define L_RESET "Reiniciar OnStep"
#define L_RESET_FWU "Reiniciar OnStep para cargar el firmware"
#define L_RESET_MSG1 "OnStep debe estar en Inicio o estacionado, de lo contrario se ignora la solicitud de reinicio."
...
#define L_DOWN_MESSAGE7 "Cableado incorrecto de los pines de la fuente de alimentación. Gnd debe compartirse entre la MCU de OnStep y la MCU de Addon."
...
#define L_GE_MOTOR_FAULT "Fallo del motor/controlador"
#define L_GE_ALT_MIN "Por debajo del límite del horizonte" 
#define L_GE_LIMIT_SENSE "Sentido límite"
#define L_GE_DEC "Límite de dec excedido"
#define L_GE_AZM "Límite de Azm excedido"
#define L_GE_UNDER_POLE "Límite polo excedido"
...
#define L_CE_ALIGN_NOT_ACTIVE "alinear no está activo"
#define L_CE_NOT_PARKED_OR_AT_HOME "no estacionado o en Inicio"
...
#define L_CE_GOTO_FAIL "Desplazarse a falló"
#define L_CE_LIBRARY_FULL "biblioteca llena"
#define L_CE_GOTO_ERR_BELOW_HORIZON "Desplazarse a por debajo del horizonte"
#define L_CE_GOTO_ERR_ABOVE_OVERHEAD "Desplazarse a demasiado alto"
#define L_CE_SLEW_ERR_IN_STANDBY "giro en espera"
#define L_CE_SLEW_ERR_IN_PARK "giro en estacionamiento"
#define L_CE_GOTO_ERR_GOTO "ya en Desplazarse a"
#define L_CE_GOTO_ERR_OUTSIDE_LIMITS "Desplazarse a fuera de los límites"
