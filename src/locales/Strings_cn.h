...
#define L_ADV_SET_HOLD_ma "以毫安为单位的驱动保持电流，<i>注意！</i>"
#define L_ADV_SET_TRAK_ma "司机 电流以毫安为单位，<i>小心！</i>"
#define L_ADV_SET_SLEW_ma "司机 以毫安为单位的压摆电流，<i>小心！</i>"
#define L_ADV_SET_P "伺服 追踪 成比例的"
#define L_ADV_SET_I "伺服 追踪 不可缺少的"
#define L_ADV_SET_D "伺服 追踪 衍生物"
#define L_ADV_SET_P_GOTO "伺服 回转 成比例的"
#define L_ADV_SET_I_GOTO "伺服 回转 不可缺少的"
#define L_ADV_SET_D_GOTO "伺服 回转 衍生物"
