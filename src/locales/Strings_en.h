...
#define L_ADV_SET_D "Servo Tracking Derivative"
...
#define L_ADV_SET_NO_EDIT "Editing of all axes is disabled at the moment.  Perhaps this feature is not enabled (so configuration defaults are active) or you need to reboot OnStep."
