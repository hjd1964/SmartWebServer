...
"function gt(e,v){if(e.preventDefault)e.preventDefault();var a=v.charAt(0);gm[a]=1;gsend(v);}"
"function gu(e,v){if(e.preventDefault)e.preventDefault();var a=v.charAt(0);gstop(a);}"
"function gp(e,v){if(e.pointerType=='touch')return;gt(e,v);}"
"function gs(e,v){if(e.pointerType=='touch')return;gu(e,v);}"
"function gw(e){if(e&&e.pointerType=='touch')return;gstopall();}"
"function gc(e){if(e.preventDefault)e.preventDefault();return false;}"
"window.addEventListener('pointerup',gw);"
"window.addEventListener('pointercancel',gw);"
"window.addEventListener('touchend',gstopall);"
"window.addEventListener('blur',gstopall);"
"document.addEventListener('visibilitychange',function(){if(document.hidden)gstopall();});"
"</script>"
"<button class='gb' ontouchstart=\"gt(event,'n1')\" ontouchend=\"gu(event,'n0')\" ontouchcancel=\"return gc(event)\" ontouchmove=\"return gc(event)\" onpointerdown=\"gp(event,'n1')\" onpointerup=\"gs(event,'n0')\" onpointercancel=\"gs(event,'n0')\" oncontextmenu=\"return gc(event)\" type='button'>" BUTTON_N "</button><br />"
"<button class='gb' ontouchstart=\"gt(event,'e1')\" ontouchend=\"gu(event,'e0')\" ontouchcancel=\"return gc(event)\" ontouchmove=\"return gc(event)\" onpointerdown=\"gp(event,'e1')\" onpointerup=\"gs(event,'e0')\" onpointercancel=\"gs(event,'e0')\" oncontextmenu=\"return gc(event)\" type='button'>" BUTTON_E "</button>"
"<button class='gb' onpointerdown=\"g('sy')\" title='Sync' type='button'>" BUTTON_SYNC "</button>"
"<button class='gb' ontouchstart=\"gt(event,'w1')\" ontouchend=\"gu(event,'w0')\" ontouchcancel=\"return gc(event)\" ontouchmove=\"return gc(event)\" onpointerdown=\"gp(event,'w1')\" onpointerup=\"gs(event,'w0')\" onpointercancel=\"gs(event,'w0')\" oncontextmenu=\"return gc(event)\" type='button'>" BUTTON_W "</button><br />"
"<button class='gb' ontouchstart=\"gt(event,'s1')\" ontouchend=\"gu(event,'s0')\" ontouchcancel=\"return gc(event)\" ontouchmove=\"return gc(event)\" onpointerdown=\"gp(event,'s1')\" onpointerup=\"gs(event,'s0')\" onpointercancel=\"gs(event,'s0')\" oncontextmenu=\"return gc(event)\" type='button'>" BUTTON_S "</button><br />";
